...
const ChatArea = () => {
  ...
  return (
    <section
      className="mdlg:w-full xxs:pt-[80px] xs:pb-[80px] xllg:p-4 h-[calc(100vh-60px-99px)] w-screen overflow-x-hidden overflow-y-auto px-5 py-4 md:pt-[70px] lg:pt-5 lg:pb-[95px]"
